...
public abstract class CustomMeshBlockRenderer<T extends BlockEntity & MeshAnimatable, M extends MeshModel<T>>
		extends MeshRenderer<T, M> {
	public CustomMeshBlockRenderer(M model) {
		super(model);
	}
