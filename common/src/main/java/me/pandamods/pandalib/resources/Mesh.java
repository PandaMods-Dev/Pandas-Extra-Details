...
public record Mesh(String format_version, float scale, Map<String, Object> mesh, Map<String, Bone> bone) {
	public record Object(Vector3f position, Vector3f rotation, Face[] faces) {
		public record Face(Vector3f normal, Vertex[] vertices, String texture_name) {
